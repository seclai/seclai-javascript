...
export type MemoryBankAiAssistantResponse = components["schemas"]["routers__api__memory_banks__MemoryBankAiAssistantResponse"];
...
export type MemoryBankConfigResponse = components["schemas"]["routers__api__memory_banks__MemoryBankConfigResponse"];
...
export type AiAssistantGenerateResponse = components["schemas"]["routers__api__solutions__AiAssistantGenerateResponse"];
...
export type AiAssistantAcceptResponse = components["schemas"]["routers__api__solutions__AiAssistantAcceptResponse"];

/** Proposed action in a solution AI plan. */
export type ProposedActionResponse = components["schemas"]["routers__api__solutions__ProposedActionResponse"];

/** Executed action in a solution AI plan. */
export type ExecutedActionResponse = components["schemas"]["routers__api__solutions__ExecutedActionResponse"];
...
export type GovernanceAiAssistantResponse = components["schemas"]["routers__api__governance__GovernanceAiAssistantResponse"];

/** Governance AI accept response. */
export type GovernanceAiAcceptResponse = components["schemas"]["routers__api__governance__GovernanceAiAcceptResponse"];
...
export type GovernanceProposedPolicyActionResponse = components["schemas"]["routers__api__governance__ProposedPolicyActionResponse"];

/** Applied policy action from governance AI. */
export type GovernanceAppliedActionResponse = components["schemas"]["routers__api__governance__AppliedActionResponse"];
